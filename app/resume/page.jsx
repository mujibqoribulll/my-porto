...
const Resume = () => {
    ...
    const about = {
        title: "About me",
        description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam officiis sint ipsum dignissimos, quibusdam blanditiis molestiae explicabo.",
        info: [
            {
                filedName: "Name",
                                        ...
                                        about?.info?.map((item, index) => {
                                            return (
                                                <li key={index} className='flex justify-center items-center xl:justify-start gap-4'>
                                                    ...
                                                    <span className='text-xl w-full'>{item?.filedValue}</span>
                                                </li>
                                            )
                                        })
                                    }
